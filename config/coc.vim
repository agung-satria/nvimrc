...
nmap <leader>acl  <Plug>(coc-codelens-action)
...
" Manage extensions.
nnoremap <silent><nowait> <space>ae  :<C-u>CocList extensions<cr>
" Show commands.
nnoremap <silent><nowait> <space>ac  :<C-u>CocList commands<cr>
" Find symbol of current document.
nnoremap <silent><nowait> <space>ao  :<C-u>CocList outline<cr>
" Search workspace symbols.
nnoremap <silent><nowait> <space>as  :<C-u>CocList -I symbols<cr>
